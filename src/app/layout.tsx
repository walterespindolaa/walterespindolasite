...
export const metadata: Metadata = {
    ...
    description: 'CEO da Zephyr Investimentos, construtor de três sistemas com IA e assessor de investimentos de alta renda. Conheça a trajetória, os sistemas e as formas de trabalhar comigo.',
    keywords: ['Walter Espindola', 'Zephyr Investimentos', 'assessor de investimentos', 'alta renda', 'construtor de sistemas', 'SaaS com IA', 'Atlas', 'mentoria'],
