...
export const portfolioData: PortfolioData = {
    ...
    projects: [
        {
            ...
            slug: 'atlas',
            title: 'Atlas',
            description: 'O plano que um bom assessor faria, num app, todo dia. Organização financeira pessoal com projeção patrimonial e relatórios automáticos.',
            ...
            features: [
                {
                    ...
                    items: [
                        ...
                        'Método Atlas: 5 relatórios com os mesmos diagnósticos que uso com 300+ famílias',
        ...
        },
        {
            ...
            highlights: [
                ...
                'Relatórios de planejamento gerados automaticamente a partir dos dados do cliente',
            ...
            features: [
                {
                    ...
                    items: [
                        ...
                        'Relatório completo em PDF e apresentação gerados automaticamente',
                    ],
                },
            ],
            challengesAndSolutions: [
        ...
        },
        {
            ...
            description: 'Hub de conteúdo pra criadores: da ideia ao publicado num fluxo só, com apoio no roteiro e integração com as redes.',
            longDescription: 'Todo criador tem ideia; poucos têm processo. O gargalo não é criatividade, é o caminho da ideia até o publicado. Construí um hub que segura a mão em cada etapa.',
            ...
            highlights: [
                ...
                'Tendências pesquisadas na web e geração de ideias',
            ],
            features: [
                {
                    title: 'O que construí pra resolver a dor',
                    items: [
                        'Ideação e roteiro, do branco à pauta pronta',
            ...
            challengesAndSolutions: [
                {
                    ...
                    solution: 'Um fluxo único, com apoio em cada etapa, pra ideia nunca se perder entre o pensar e o publicar.',
                },
            ],
    ...
    experiences: [
        ...
        },
        {
            ...
            description: 'Três SaaS construídos do zero, sozinho, pela mesma receita: dados, login, automação, pagamento e lançamento.',
            responsibilities: [
            ...
            isOngoing: true,
            type: 'self-employed',
            impact: ['3 SaaS no ar', 'Centenas de telas e automações', 'Cada um nascido de uma dor real'],
        },
        {
            id: 'mentor',
            company: 'Da Ideia ao Sistema em 24 horas',
            position: 'Mentor',
            description: 'Curso e mentoria 1:1 pra quem tem uma ideia e quer colocá-la no ar sem saber programar. O mesmo método que usei nos meus sistemas.',
            skills: ['Método', 'Produto', 'Lançamento', 'Execução'],
            startDate: '2026-01',
            isOngoing: true,
            type: 'self-employed',
        },
    ...
    achievements: [
        ...
        },
        {
            ...
            issuer: 'Método Atlas',
            date: '2026',
            description: 'Planejamentos financeiros reais que deram origem ao método e aos relatórios do Atlas.',
            category: 'recognition',
            tags: ['Planejamento', 'Método'],
        },
        {
            id: 'saas',
            title: '3 SaaS construídos do zero',
            issuer: 'Atlas · Zephyr · Cria',
            date: '2020 – 2026',
            description: 'Três produtos completos, sozinho, pela mesma receita repetível.',
            category: 'recognition',
            tags: ['Construção', 'Sistemas'],
        },
        {
            id: 'anos',
    ...
    hardSkills: [
        ...
        { name: 'Construção de SaaS', level: 'expert', category: 'ai', description: 'Da dor à tela, do zero ao no ar.' },
        ...
        { name: 'Automação no produto', level: 'advanced', category: 'ai', description: 'Relatórios, diagnósticos e copilotos dentro do fluxo.' },
    ...
    faqs: [
        ...
        },
        {
            ...
            answer: 'Com método: dor clara em uma frase, telas essenciais no papel, dados bem definidos, construção com as ferramentas certas, pagamento e lançamento. É o mesmo esqueleto nos três.',
        },
        {
